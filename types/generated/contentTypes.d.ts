...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    homePageImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    homePageView: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    navBarPngImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    navbarView: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiCouponCoupon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    couponDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    couponLimit: Schema.Attribute.BigInteger;
    couponName: Schema.Attribute.String & Schema.Attribute.Required;
    couponRate: Schema.Attribute.Integer & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    minCartValue: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDigitalOrderDigitalOrder
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::digital-order.digital-order'
    > &
      Schema.Attribute.Private;
...
export interface ApiMaterialTypeMaterialType
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isHomePageBanner: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    isMobileNavbar: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    navabarImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    orderStatus: Schema.Attribute.Boolean & Schema.Attribute.Required;
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    userAddress: Schema.Attribute.Component<'user-address.user-address', false>;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gender: Schema.Attribute.Enumeration<['Men', 'Women', 'Girl', 'Boy']> &
      Schema.Attribute.Required;
    gst: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 3;
    ...
    item_Gross_Weight: Schema.Attribute.Decimal & Schema.Attribute.Required;
    item_Height: Schema.Attribute.Decimal & Schema.Attribute.Required;
    item_Net_Weight: Schema.Attribute.Decimal & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    > &
      Schema.Attribute.Private;
    material: Schema.Attribute.Enumeration<['Gold', 'Silver', 'Brace']> &
      Schema.Attribute.Required;
    material_type: Schema.Attribute.Relation<
      'manyToOne',
      'api::material-type.material-type'
    >;
    metal_Certification: Schema.Attribute.Enumeration<['BIS Hallmark', 'SGL']> &
      Schema.Attribute.Required;
    metal_Color: Schema.Attribute.Enumeration<['Yellow', 'White', 'Rose']> &
      Schema.Attribute.Required;
    ...
    product_Status: Schema.Attribute.Boolean & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    sku_Id: Schema.Attribute.UID<'product_Name'> & Schema.Attribute.Required;
    stock_Quantity: Schema.Attribute.Integer & Schema.Attribute.Required;
    stone_information: Schema.Attribute.Component<
      'stone-information.stone-information',
      true
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    value_Addition: Schema.Attribute.Decimal & Schema.Attribute.Required;
  };
}
...
export interface ApiSubcategorySubcategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    png_Image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    digital_orders: Schema.Attribute.Relation<
      'oneToMany',
      'api::digital-order.digital-order'
    >;
    email: Schema.Attribute.Email &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::digital-order.digital-order': ApiDigitalOrderDigitalOrder;
      'api::home-banner.home-banner': ApiHomeBannerHomeBanner;
      'api::material-type.material-type': ApiMaterialTypeMaterialType;
